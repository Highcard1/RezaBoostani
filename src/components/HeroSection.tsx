export default function HeroSection() {
  return (
    <section id="home" className=" relative pt-20 pb-16 px-0 sm:px-0 lg:px-0 bg-white  overflow-hidden w-full">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white/95">
        <div className="flex flex-col lg:flex-row items-center justify-between shadow-lg p-8 gap-8">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-xl sm:text-2xl text-gray-600  mb-8 max-w-3xl lg:mx-0 mx-auto font-medium">
              Product Manager & Builder | EV & Climate Tech | SaaS & Startups
            </p>
            <p className="text-lg text-gray-500  mb-12 max-w-2xl lg:mx-0 mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a
                href="#about"
                className="border-2 border-gray-300  text-gray-700  hover:bg-gray-50  px-8 py-4 rounded-lg font-medium transition-all duration-200 transform hover:scale-105"
              >
