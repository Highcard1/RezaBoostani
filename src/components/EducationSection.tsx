          ...
          <div>
            ...
            <div className="ml-10 space-y-6 border-l-4 border-blue-200 pl-6">
              <div>
                ...
                <p className="text-sm">The degree that laid the foundation for Reza&apos;s product thinking and business acumen. This program sparked his journey into the startup world and equipped him with tools to turn innovative ideas into market-ready solutions.</p>
              </div>
              <div>
                <h4 className="text-xl font-bold">Azad University – BSc.</h4>
                <p className="text-sm italic mb-1">Where it all began—Reza&apos;s technical roots.</p>
                <p className="text-sm">Here, he learned to build software before he learned to build strategy.</p>
              </div>
            </div>
          </div>
            ...
            <div className="ml-10 space-y-8 border-l-4 border-pink-200 pl-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                  <FaPiedPiper className="text-pink-600" />
                </div>
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Pendo.io · Issued May 2023</span>
                  </div>
                  <p className="text-sm">Understanding user behavior at scale to make data-driven product decisions.</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Pendo.io · Issued Jan 2023</span>
                  </div>
                  <p className="text-sm">Driving product-led growth and customer success.</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Pendo.io · Issued Dec 2023</span>
                  </div>
                  <p className="text-sm">Applying AI and analytics to product management.</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Scrum.org · Issued Feb 2023</span>
                  </div>
                  <p className="text-sm">Mastering agile frameworks and stakeholder alignment.</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    <span className="font-bold">The Forge Startup Survival Program</span>
                    <span className="text-sm">The Forge McMaster · Issued Sep 2022</span>
                  </div>
                  <p className="text-sm">Skills: Pitch presentation · Idea development</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Microsoft · Issued Jan 2024</span>
                  </div>
                  <p className="text-sm">Bridging cloud infrastructure knowledge with AI-powered product design.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Microsoft · Issued May 2023</span>
                  </div>
                  <p className="text-sm">Skills: Cloud data · Cloud networking · Cloud Security</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">University of Michigan · Issued Jan 2024</span>
                  </div>
                  <p className="text-sm">Skills: Payment Systems · FinTech</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <span className="text-sm">Google · Issued Jun 2023</span>
                  </div>
                  <p className="text-sm">Skills: AI ads · AI automation · AI strategy</p>
                </div>
              </div>
