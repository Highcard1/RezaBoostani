          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-200 mb-1">Strategic Product Leadership</h4>
                  <p className="text-gray-600 dark:text-gray-200 text-sm">From roadmap to launch, with deep market understanding</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-200 mb-1">Full-Stack Development</h4>
                  <p className="text-gray-600 dark:text-gray-200 text-sm">Write code, understand architecture, ship faster</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-200 mb-1">User Research & Validation</h4>
                  <p className="text-gray-600 dark:text-gray-200 text-sm">300+ interviews, rapid prototyping, PMF validation</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-200 mb-1">Startup & Fundraising</h4>
                  <p className="text-gray-600 dark:text-gray-200 text-sm">Secured funding, built partnerships, scaled teams</p>
                </div>
              </div>
            </div>
          </div>
